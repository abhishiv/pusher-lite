...
(function() {
  ...
  PusherChannel = (function(_super) {
    ...
    function PusherChannel(channel_name, channel_data, jsonify) {
      if (jsonify == null) {
        jsonify = true;
      }
  ...
  PusherClient = (function(_super) {
    ...
    PusherClient.prototype.subscribe = function(channel_name, channel_data, jsonify) {
      ...
      if (msg.type === 'utf8') {
        ...
        if (channel) {
          if (channel.jsonify) {
            ...
            return channel.emit(payload.event, payload.data);
          }
        }
      }
    };
