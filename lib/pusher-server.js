...
(function() {
  var EventEmitter, PusherChannel, PusherServer, WebSocket, crypto, uuid, _,
  ...
  PusherServer = (function(_super) {

    __extends(PusherServer, _super);

    PusherServer.prototype.state = {
      name: "disconnected",
      socket_id: null
    };

    function PusherServer(credentials) {
    ...
    PusherServer.prototype.subscribe = function(channel_name, channel_data) {
    ...
    PusherServer.prototype.unsubscribe = function(channel_name, channel_data) {
      var auth, channel, req, stringToSign;
    ...
    PusherServer.prototype.resetActivityCheck = function() {
      var _this = this;
    ...
    PusherServer.prototype.connect = function() {
      var _this = this;
    ...
    PusherServer.prototype.recieveMessage = function(msg) {
      ...
      if (msg.type === 'utf8') {
        ...
        channel = this.channels[payload.channel_name];
