...
(function() {
  var EventEmitter, PusherChannel, PusherClient, WebSocket, crypto, uuid,
  ...
  PusherClient = (function(_super) {
      ...
      return this.activityTimeout = setTimeout((function(_this) {
        return function() {
          ...
          return _this.waitingTimeout = setTimeout(function() {
            ...
            for (c in _this.channels) {
              _this.unsubscribe(c.channel_name, c.channel_data);
            }
            if (PusherClient.debug) {
    ...
    PusherClient.prototype.recieveMessage = function(msg) {
      ...
      if (msg.type === 'utf8') {
        ...
        if (payload.event === "pusher:error" && PusherClient.debug) {
          console.log(payload);
        }
        if (channel) {
